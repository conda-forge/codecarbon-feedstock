...
Home: https://codecarbon.io/

Package license: MIT

Summary: Track and reduce CO2 emissions from your computing

Development: https://github.com/mlco2/codecarbon

Documentation: https://docs.codecarbon.io/

CodeCarbon is a Python package that estimates the carbon emissions produced by
computer programs, from straightforward algorithms to deep neural networks.

It measures the electricity consumed by the machine it runs on and converts it
to CO2 using the carbon intensity of the local electricity grid, taking into
account your computing infrastructure, location, usage and running time. It can
be used as a Python context manager, a decorator, or from the command line, and
works either standalone or by reporting to the CodeCarbon API and dashboard.
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/codecarbon-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/codecarbon-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
```
conda install codecarbon codecarbon-viz
```
...
```
mamba install codecarbon codecarbon-viz
```
...
pixi add codecarbon codecarbon-viz
# for installing globally
pixi global install codecarbon codecarbon-viz
```
...
It is possible to list all of the versions of `codecarbon` available on your platform:
...
```
pixi search codecarbon --channel conda-forge
```
